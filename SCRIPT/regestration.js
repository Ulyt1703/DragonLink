...
let buttonLoad = document.querySelector(".regestration__button")
window.addEventListener("load", function(){
    buttonLoad.classList.add("new__reg-button")
})

document.getElementById("telephone").setAttribute('autocomplete', 'off')
document.getElementById("Password__complete").setAttribute('autocomplete', 'off')
document.getElementById("email__complete").setAttribute('autocomplete', 'off')
document.getElementById("username__complete").setAttribute('autocomplete', 'off')